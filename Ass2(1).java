...
each instance variable. calculates the invoice amount (i.e. multiplies the quantity by the price per item), 
...
class Invoice {
    ...
    public static void main(String[] args) {
        Invoice invoice = new Invoice("1234", "Hammer", 5, 50.0);
        System.out.println("Part Number: " + invoice.getPartNumber());
        System.out.println("Part Description: " + invoice.getPartDescription());
        System.out.println("Quantity: " + invoice.getQuantity());
        System.out.println("Price per Item: Rs." + invoice.getPricePerItem());
        System.out.println("Total Invoice Amount: Rs." + invoice.getInvoiceAmount());
    }
}
